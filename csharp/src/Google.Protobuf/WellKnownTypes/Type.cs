...
namespace Google.Protobuf.WellKnownTypes {
  ...
  /// </summary>
  public sealed partial class Type : pb::IMessage, pb::IDeepCloneable {
    ...
    public Type(Type other) : this() {
      name_ = other.name_;
      fields_ = (pbc::RepeatedField<global::Google.Protobuf.WellKnownTypes.Field>) other.fields_.Clone();
      oneofs_ = (pbc::RepeatedField<string>) other.oneofs_.Clone();
      options_ = (pbc::RepeatedField<global::Google.Protobuf.WellKnownTypes.Option>) other.options_.Clone();
      sourceContext_ = other.sourceContext_ != null ? (global::Google.Protobuf.WellKnownTypes.SourceContext) other.sourceContext_.Clone() : null;
  ...
  /// </summary>
  public sealed partial class Field : pb::IMessage, pb::IDeepCloneable {
  ...
  /// </summary>
  public sealed partial class Enum : pb::IMessage, pb::IDeepCloneable {
    ...
    public Enum(Enum other) : this() {
      name_ = other.name_;
      enumvalue_ = (pbc::RepeatedField<global::Google.Protobuf.WellKnownTypes.EnumValue>) other.enumvalue_.Clone();
      options_ = (pbc::RepeatedField<global::Google.Protobuf.WellKnownTypes.Option>) other.options_.Clone();
      sourceContext_ = other.sourceContext_ != null ? (global::Google.Protobuf.WellKnownTypes.SourceContext) other.sourceContext_.Clone() : null;
      syntax_ = other.syntax_;
    }
  ...
  /// </summary>
  public sealed partial class EnumValue : pb::IMessage, pb::IDeepCloneable {
  ...
  /// enumeration, etc.
  /// </summary>
  public sealed partial class Option : pb::IMessage, pb::IDeepCloneable {
    ...
    public Option(Option other) : this() {
      name_ = other.name_;
      value_ = other.value_ != null ? (global::Google.Protobuf.WellKnownTypes.Any) other.value_.Clone() : null;
    }
